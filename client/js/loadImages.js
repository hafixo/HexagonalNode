...
Img.hexHover.src = "../client/img/hexHover.png";
Img.hexAvailable = new Image();
Img.hexAvailable.src = "../client/img/hexAvailable.png";
Img.hexSelected = new Image();
Img.hexSelected.src = "../client/img/hexSelected.png";
Img.hexTargeted = new Image();
Img.hexTargeted.src = "../client/img/hexTargeted.png";
